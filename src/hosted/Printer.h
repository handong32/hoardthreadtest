...
#ifndef APPS_HOARD_HOSTED_SRC_PRINTER_H_
#define APPS_HOARD_HOSTED_SRC_PRINTER_H_
...
static ebbrt::Promise<void> future;
...
class Printer : public ebbrt::StaticSharedEbb<Printer>,
 ...
 public:
  ...
  static ebbrt::Future<void> Wait();
};

constexpr auto printer = ebbrt::EbbRef<Printer>(kPrinterEbbId);

#endif  // APPS_HOARD_HOSTED_SRC_PRINTER_H_
